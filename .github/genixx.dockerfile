...
RUN apt-get update && \
    ...
    llvm-15-dev=1:15.0.7-0ubuntu0.22.04.3 python3=3.10.6-1~22.04 python3-pip=22.0.2+dfsg-1ubuntu0.3 shellcheck=0.8.0-2 git=1:2.34.1-1ubuntu1.9 make=4.3-4.1build1 \
    ...
    clang-tools=1:14.0-55~exp2 python2=2.7.18-3 rsync=3.2.7-0ubuntu0.22.04.2 graphviz=2.42.2-6 libc++-15-dev=1:15.0.7-0ubuntu0.22.04.3 \
